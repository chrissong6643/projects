...
Number_of_iterations = 5000  # Experiment to pick your own number of ITERATIONS
Step_size = 0.1  # Experiment to pick your own STEP number
...
class Network(BaseNetwork):
    def __init__(self, data_layer):
        ...
        self.hidden_layer2 = HiddenLayer(self.hidden_layer1, 1)
        self.hidden_layer3 = HiddenLayer(self.hidden_layer2, 1)
        self.bias_layer1 = BiasLayer(self.hidden_layer3, "ReLU")
        self.output_layer1 = OutputLayer(self.bias_layer1, 1, "Sigmoid")
...
class Trainer:
    ...
    def net_setup(self, training_data):
        ...
        # change the sine data from values between -1 and 1 to either 0 or 1 in order to feed into cross entropy loss, it needs binary
        # y = (y >= 0).astype(int)
        self.loss_layer = CrossEntropyLoss(self.network.get_output_layer(), y)

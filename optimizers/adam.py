...
class AdamSolver:
    ...
    def __init__(self, learning_rate: float, modules: List[LinearLayer], beta1: float = 0.9, beta2: float = 0.999,
                 epsilon: float = 1e-8):
    ...
    def step(self):
        ...
        for module in self.modules:
            ...
            module.m = self.beta1 * module.m + (1 - self.beta1) * np.square(module.G)
            module.v = self.beta2 * module.v + (1 - self.beta2) * module.G
